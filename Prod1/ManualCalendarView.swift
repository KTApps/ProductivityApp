...
//import SwiftUI
//
//struct ManualCalendarView: View {
//    @State var todayDate = Date()
//    @State var startDate = TimestampCalculator.instance.convertTimestampToDate(timestamp: 0.0)
//
...
//}
//    
//struct ManualCalendarView_Previews: PreviewProvider {
